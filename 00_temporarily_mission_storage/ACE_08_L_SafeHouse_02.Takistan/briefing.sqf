...
<br/>
目標：<br/>
　複数の情報筋によって、<marker name='Target1_mark'>作戦座標０５７－０１５</marker>に存在する<br/>
...
<br/>
予想される敵戦力：<br/>
　敵は２名の戦闘員と最低１名の組織幹部が常駐して<br/>
　いると伝えられているが、目標周辺には常に１０名程度の<br/>
...
<marker name='Target1_mark'>赤色斜線で示されている範囲</marker>に存在する全抵抗を排除せよ。<br/>
","強襲","Task1"];
